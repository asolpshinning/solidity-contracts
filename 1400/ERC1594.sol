...
contract ERC1594 is IERC1594, ERC20Token, Ownable {
    ...
    // In this implementation, no function is able to reset the issuance
    // If needed in the future, implement one more function to reset the value of `issuance` variable
    // to false. That function is not a part of the standard (EIP-1594) as it depends on the various factors
    ...
    /**
     * @notice Transfers of securities may fail for a number of reasons. So this function will be used to understand the
     * cause of failure by getting the byte value. Which will be the ESC that follows the EIP 1066. ESC can be mapped
